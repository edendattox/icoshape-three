...
import { PixelShader } from "./postProcessing";
...
export default class sketch {
  ...
  addObjects() {
    ...
    this.mesh = new THREE.Mesh(this.geometry1, this.material);
    this.meshLines = new THREE.Mesh(this.geometry1, this.material1);
